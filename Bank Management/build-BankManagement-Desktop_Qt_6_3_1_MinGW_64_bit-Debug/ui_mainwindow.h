...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QFont font4;
        font4.setFamilies({QString::fromUtf8("OCR A Extended")});
        ...
        QFont font6;
        font6.setFamilies({QString::fromUtf8("OCR A Extended")});
        ...
        layoutWidget2->setGeometry(QRect(430, 40, 381, 131));
        verticalLayout_3 = new QVBoxLayout(layoutWidget2);
        verticalLayout_3->setObjectName(QString::fromUtf8("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        label_congrats = new QLabel(layoutWidget2);
        ...
        layoutWidget3 = new QWidget(page_5);
        layoutWidget3->setObjectName(QString::fromUtf8("layoutWidget3"));
        layoutWidget3->setGeometry(QRect(260, 100, 681, 71));
        ...
        plainTextEdit_AccNoToSearch = new QPlainTextEdit(layoutWidget3);
        ...
        pushButton_submitToSearch = new QPushButton(layoutWidget3);
        ...
        layoutWidget4->setGeometry(QRect(140, 0, 871, 182));
        ...
        plainTextEdit_ccNumInVal = new QPlainTextEdit(layoutWidget4);
        ...
        plainTextEdit_cvvNumInVal = new QPlainTextEdit(layoutWidget4);
